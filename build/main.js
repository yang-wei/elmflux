...
Elm.AnimationFrame.make = function (_elm) {
   ...
   if (_elm.AnimationFrame.values) return _elm.AnimationFrame.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   return _elm.AnimationFrame.values = {_op: _op,frameWhen: frameWhen,frame: frame};
};
Elm.Component = Elm.Component || {};
Elm.Component.Container = Elm.Component.Container || {};
Elm.Component.Container.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Container = _elm.Component.Container || {};
   if (_elm.Component.Container.values) return _elm.Component.Container.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var wrap = function (mainView) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("https://github.com/yang-wei/elmflux")]),
              _U.list([A2($Html.img,
              _U.list([$Html$Attributes.alt("Fork me on GitHub")
                      ,A2($Html$Attributes.attribute,"data-canonical-src","https://s3.amazonaws.com/github/ribbons/forkme_right_gray_6d6d6d.png")
                      ...
                      ,A2($Html$Attributes.attribute,"style","position: absolute; top: 0; right: 0; border: 0;")]),
              _U.list([]))]))
              ,A2($Html.header,
              _U.list([]),
              _U.list([A2($Html.h1,
                      _U.list([$Html$Attributes.$class("title")]),
                      _U.list([A2($Html.a,_U.list([$Html$Attributes.href("#")]),_U.list([$Html.text("Elm Flux")]))]))
                      ,A2($Html.h3,_U.list([$Html$Attributes.$class("subtitle")]),_U.list([$Html.text("Visualization of Elm Signals")]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.id("app")]),_U.list([mainView]))
              ,A2($Html.footer,
              _U.list([]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("footnote")]),
              _U.list([$Html.text("foldp by "),A2($Html.a,_U.list([$Html$Attributes.href("http://elm-lang.org/")]),_U.list([$Html.text("Elm 0.16")]))]))]))]));
   };
   var container = function (appState) {    return A2($Signal.map,wrap,appState);};
   return _elm.Component.Container.values = {_op: _op,container: container};
};
Elm.Config = Elm.Config || {};
Elm.Config.Size = Elm.Config.Size || {};
Elm.Config.Size.make = function (_elm) {
   "use strict";
   _elm.Config = _elm.Config || {};
   _elm.Config.Size = _elm.Config.Size || {};
   if (_elm.Config.Size.values) return _elm.Config.Size.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var seriesValueWidth = 120;
   var _p0 = {ctor: "_Tuple2",_0: 640,_1: 70};
   var seriesWidth = _p0._0;
   var seriesHeight = _p0._1;
   return _elm.Config.Size.values = {_op: _op,seriesWidth: seriesWidth,seriesHeight: seriesHeight,seriesValueWidth: seriesValueWidth};
};
Elm.Component = Elm.Component || {};
Elm.Component.Line = Elm.Component.Line || {};
Elm.Component.Line.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Line = _elm.Component.Line || {};
   if (_elm.Component.Line.values) return _elm.Component.Line.values;
   var _U = Elm.Native.Utils.make(_elm),
   $AnimationFrame = Elm.AnimationFrame.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Config$Size = Elm.Config.Size.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var axisLineStyle = _U.update($Graphics$Collage.defaultLine,{width: 1.5});
   var timeAxisArrow = function () {
      var arrowHeadPoint = $Config$Size.seriesWidth * 0.5;
      var arrowWingPointX = $Config$Size.seriesWidth * 0.49;
      var axis = $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: arrowWingPointX,_1: 5}
                                                ,{ctor: "_Tuple2",_0: arrowHeadPoint,_1: 0}
                                                ,{ctor: "_Tuple2",_0: arrowWingPointX,_1: -5}]));
      return A2($Graphics$Collage.traced,axisLineStyle,axis);
   }();
   var initialSeries = _U.list([]);
   var endPoint = $Basics.negate($Config$Size.seriesWidth / 2);
   var timeAxis = function () {
      var axis = $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: endPoint,_1: 0},{ctor: "_Tuple2",_0: $Config$Size.seriesWidth,_1: 0}]));
      return A2($Graphics$Collage.traced,axisLineStyle,axis);
   }();
   var timeAxisTick = function () {
      var axis = $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: endPoint,_1: 10},{ctor: "_Tuple2",_0: endPoint,_1: -10}]));
      return A2($Graphics$Collage.traced,axisLineStyle,axis);
   }();
   var startPoint = $Config$Size.seriesWidth / 2;
   var objectMoveX = F2(function (x,shape) {    return A2($Graphics$Collage.moveX,x,A2($Graphics$Collage.moveX,startPoint,shape));});
   var _p0 = {ctor: "_Tuple2",_0: 25,_1: 25};
   var pointWidth = _p0._0;
   var pointHeight = _p0._1;
   var maxDisplayPoint = $Config$Size.seriesWidth / pointWidth | 0;
   var makeBox = F3(function (x,value,color) {
      var displayedValue = A2(objectMoveX,x,A2($Graphics$Collage.moveY,$Basics.negate(pointHeight),$Graphics$Collage.text($Text.fromString(value))));
      var point = A2(objectMoveX,x,A2($Graphics$Collage.filled,color,A2($Graphics$Collage.oval,pointWidth,pointHeight)));
      return $Graphics$Collage.group(_U.list([point,displayedValue]));
   });
   var view = F2(function (color,series) {
      var boxes = A2($List.map,function (_p1) {    var _p2 = _p1;return A3(makeBox,_p2.x,_p2.value,color);},series);
      return A3($Graphics$Collage.collage,
      $Config$Size.seriesWidth,
      $Config$Size.seriesHeight,
      A2($Basics._op["++"],_U.list([timeAxisTick,timeAxis,timeAxisArrow]),boxes));
   });
   var moveXAsTimePassed = F2(function (delta,box) {    return _U.update(box,{x: box.x - pointWidth * 6 * $Time.inSeconds(delta)});});
   var moveXAsNewBoxIsAdded = function (box) {    return _U.update(box,{x: box.x - pointWidth});};
   var Box = F2(function (a,b) {    return {x: a,value: b};});
   var initBox = F2(function (x,value) {    return A2(Box,x,value);});
   var Action = function (a) {    return {ctor: "Action",_0: a};};
   var TimeSignal = function (a) {    return {ctor: "TimeSignal",_0: a};};
   var transformIntoLine = F2(function (f,signal) {
      var update = F2(function (action,series) {
         var _p3 = action;
         if (_p3.ctor === "TimeSignal") {
               return A2($List.map,moveXAsTimePassed(_p3._0),series);
            } else {
               var forwardedSeries = A2($List.take,maxDisplayPoint,A2($List.map,moveXAsNewBoxIsAdded,series));
               var value = f($Basics.toString(_p3._0));
               var newBox = A2(initBox,0,value);
               return A2($List._op["::"],newBox,forwardedSeries);
            }
      });
      var action = A2($Signal.merge,A2($Signal.map,Action,signal),A2($Signal.map,TimeSignal,$AnimationFrame.frame));
      return A3($Signal.foldp,update,initialSeries,action);
   });
   var toStreamLine = F3(function (color,f,signal) {    return A2($Signal.map,view(color),A2(transformIntoLine,f,signal));});
   return _elm.Component.Line.values = {_op: _op,toStreamLine: toStreamLine};
};
Elm.Component = Elm.Component || {};
Elm.Component.NavBar = Elm.Component.NavBar || {};
Elm.Component.NavBar.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.NavBar = _elm.Component.NavBar || {};
   if (_elm.Component.NavBar.values) return _elm.Component.NavBar.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var submenuLink = function (_p0) {
      var _p1 = _p0;
      return A2($Html.li,_U.list([]),_U.list([A2($Html.a,_U.list([$Html$Attributes.href(_p1._0)]),_U.list([$Html.text(_p1._1)]))]));
   };
   var submenuTitle = function (label) {    return A2($Html.li,_U.list([$Html$Attributes.$class("submenu-title")]),_U.list([$Html.text(label)]));};
   var navbar = A2($Html.div,
   _U.list([]),
   _U.list([A2($Html.ul,
   _U.list([$Html$Attributes.$class("signals-menu")]),
   _U.list([submenuTitle("Basic Signal")
           ,submenuLink({ctor: "_Tuple2",_0: "#/mouseSignal",_1: "Mouse"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/keyboardSignal",_1: "Keyboard"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/windowSignal",_1: "Window"})
           ,submenuTitle("Time Signal")
           ,submenuLink({ctor: "_Tuple2",_0: "#/timeEvery",_1: "every"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/timeFps",_1: "fps"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/timeFpsWhen",_1: "fpsWhen"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/timeDelay",_1: "delay"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/timeSince",_1: "since"})
           ,submenuTitle("Signal Library")
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalMap",_1: "map"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalMap2",_1: "map2"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalFilter",_1: "filter"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalFoldp",_1: "foldp"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalMerge",_1: "merge"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalSampleOn",_1: "sampleOn"})
           ,submenuLink({ctor: "_Tuple2",_0: "#/signalDropRepeats",_1: "dropRepeats"})]))]));
   var navBarSignal = $Signal.constant(A3($Html.toElement,200,600,navbar));
   return _elm.Component.NavBar.values = {_op: _op,navBarSignal: navBarSignal};
};
Elm.Component = Elm.Component || {};
Elm.Component.Note = Elm.Component.Note || {};
Elm.Component.Note.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Note = _elm.Component.Note || {};
   if (_elm.Component.Note.values) return _elm.Component.Note.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Config$Size = Elm.Config.Size.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var toElement = function (str) {
      var textElement = $Graphics$Element.justified(A2($Text.typeface,_U.list(["Source Code Pro","consolas","inconsolata","monospace"]),$Text.fromString(str)));
      var totalWidth = $Config$Size.seriesWidth + $Config$Size.seriesValueWidth;
      return A4($Graphics$Element.container,totalWidth,$Config$Size.seriesHeight,$Graphics$Element.middle,textElement);
   };
   var emptySpace = $Signal.constant(toElement(""));
   var signalNote = function (notes) {    return $Signal.constant(toElement(notes));};
   return _elm.Component.Note.values = {_op: _op,signalNote: signalNote,emptySpace: emptySpace};
};
Elm.Config = Elm.Config || {};
Elm.Config.Color = Elm.Config.Color || {};
Elm.Config.Color.make = function (_elm) {
   "use strict";
   _elm.Config = _elm.Config || {};
   _elm.Config.Color = _elm.Config.Color || {};
   if (_elm.Config.Color.values) return _elm.Config.Color.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var white = A3($Color.rgb,255,255,255);
   var yellow = A3($Color.rgb,255,203,70);
   var orange = A3($Color.rgb,255,105,70);
   var green = A3($Color.rgb,130,215,54);
   var elmBlue = A3($Color.rgb,96,181,204);
   return _elm.Config.Color.values = {_op: _op,elmBlue: elmBlue,white: white,green: green,orange: orange,yellow: yellow};
};
Elm.Component = Elm.Component || {};
Elm.Component.Sandbox = Elm.Component.Sandbox || {};
Elm.Component.Sandbox.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Sandbox = _elm.Component.Sandbox || {};
   if (_elm.Component.Sandbox.values) return _elm.Component.Sandbox.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Component$Line = Elm.Component.Line.make(_elm),
   $Config$Size = Elm.Config.Size.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Text = Elm.Text.make(_elm);
   var _op = {};
   var signalSpacer = F2(function (x,y) {    return $Signal.constant(A2($Graphics$Element.spacer,x,y));});
   var signalValue = F2(function (color,value) {
      var display = function (value) {
         return A4($Graphics$Element.container,
         $Config$Size.seriesValueWidth,
         $Config$Size.seriesHeight,
         $Graphics$Element.middle,
         A2($Graphics$Element.width,
         $Config$Size.seriesValueWidth,
         $Graphics$Element.justified(A2($Text.color,color,$Text.fromString($Basics.toString(value))))));
      };
      return A2($Signal.map,display,value);
   });
   var signalLabel = function (name) {
      var displayName = A2($Graphics$Element.color,
      A3($Color.rgb,255,255,255),
      A2($Graphics$Element.width,
      $Config$Size.seriesWidth + $Config$Size.seriesValueWidth,
      $Graphics$Element.leftAligned(A2($Text.typeface,_U.list(["Source Code Pro","consolas","inconsolata","monospace"]),$Text.fromString(name)))));
      return $Signal.constant(displayName);
   };
   var signalSandbox = F4(function (signal,f,signalName,color) {
      var mediumHorizontalSpace = A2(signalSpacer,15,1);
      var smallVerticalSpace = A2(signalSpacer,1,10);
      var smallHorizontalSpace = A2(signalSpacer,10,1);
      var topDisplay = A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.right),_U.list([smallHorizontalSpace,signalLabel(signalName)]));
      var bottomDisplay = A2($Signal$Extra.mapMany,
      $Graphics$Element.flow($Graphics$Element.right),
      _U.list([mediumHorizontalSpace,A3($Component$Line.toStreamLine,color,f,signal),smallHorizontalSpace,A2(signalValue,color,signal),mediumHorizontalSpace]));
      return A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.down),_U.list([smallVerticalSpace,topDisplay,bottomDisplay,smallVerticalSpace]));
   });
   var simpleSignalSandbox = F3(function (signal,signalName,color) {    return A4(signalSandbox,signal,$Basics.identity,signalName,color);});
   var displaySimpleSandbox = function (signals) {
      var sandboxes = A2($List.map,function (_p0) {    var _p1 = _p0;return A3(simpleSignalSandbox,_p1._0,_p1._1,_p1._2);},signals);
      return A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.down),sandboxes);
   };
   return _elm.Component.Sandbox.values = {_op: _op,simpleSignalSandbox: simpleSignalSandbox,displaySimpleSandbox: displaySimpleSandbox};
};
...
Elm.Router.make = function (_elm) {
   ...
   var matchPrefix = F2(function (prefix,string) {
      return A2($String.startsWith,prefix,string) ? $Maybe.Just(A2($String.dropLeft,$String.length(prefix),string)) : $Maybe.Nothing;
   });
   var match = F3(function (routers,defaultRoute,url) {
      match: while (true) {
         var _p0 = routers;
         if (_p0.ctor === "[]") {
               ...
               var _p3 = _p0._0._1;
               var _p2 = _p0._0._0;
               if (_U.eq(_p2,"") || _U.eq(_p2,"/")) if (_U.eq(url,_p2)) return _p3(url); else {
                        var _v1 = _p4,_v2 = defaultRoute,_v3 = url;
                        routers = _v1;
                        defaultRoute = _v2;
                        url = _v3;
                        continue match;
                     } else {
                     var _p1 = A2(matchPrefix,_p2,url);
                     if (_p1.ctor === "Just") {
                           return _p3(_p1._0);
                        } else {
                           var _v5 = _p4,_v6 = defaultRoute,_v7 = url;
                           routers = _v5;
                           defaultRoute = _v6;
                           url = _v7;
                           continue match;
   ...
   return _elm.Router.values = {_op: _op,match: match};
};
Elm.Page = Elm.Page || {};
Elm.Page.MouseSignal = Elm.Page.MouseSignal || {};
Elm.Page.MouseSignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.MouseSignal = _elm.Page.MouseSignal || {};
   if (_elm.Page.MouseSignal.values) return _elm.Page.MouseSignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   $Config$Color = Elm.Config.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var mouseIsDownElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                             ,_0: $Mouse.isDown
                                                                             ,_1: "Mouse.isDown : Signal Bool"
                                                                             ,_2: $Config$Color.yellow}]));
   var mouseClicksSignal = $Mouse.clicks;
   var mouseClicksElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                             ,_0: mouseClicksSignal
                                                                             ,_1: "Mouse.clicks : Signal ()"
                                                                             ,_2: $Config$Color.yellow}]));
   var view = A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.down),_U.list([mouseClicksElement,mouseIsDownElement]));
   return _elm.Page.MouseSignal.values = {_op: _op,view: view,mouseClicksElement: mouseClicksElement,mouseIsDownElement: mouseIsDownElement};
};
Elm.Page = Elm.Page || {};
Elm.Page.KeyboardSignal = Elm.Page.KeyboardSignal || {};
Elm.Page.KeyboardSignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.KeyboardSignal = _elm.Page.KeyboardSignal || {};
   if (_elm.Page.KeyboardSignal.values) return _elm.Page.KeyboardSignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   $Config$Color = Elm.Config.Color.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var keyboardPressesElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                 ,_0: $Keyboard.presses
                                                                                 ,_1: "Keyboard.presses : Signal KeyCode"
                                                                                 ,_2: $Config$Color.orange}]));
   var keyboardWasdElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                              ,_0: $Keyboard.wasd
                                                                              ,_1: "Keyboard.wasd : Signal { x : Int, y : Int }"
                                                                              ,_2: $Config$Color.orange}]));
   var keyboardArrowsElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                ,_0: $Keyboard.arrows
                                                                                ,_1: "Keyboard.arrows : Signal { x : Int, y : Int }"
                                                                                ,_2: $Config$Color.orange}]));
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([keyboardArrowsElement,keyboardWasdElement,keyboardPressesElement]));
   return _elm.Page.KeyboardSignal.values = {_op: _op,view: view,keyboardPressesElement: keyboardPressesElement};
};
Elm.Page = Elm.Page || {};
Elm.Page.WindowSignal = Elm.Page.WindowSignal || {};
Elm.Page.WindowSignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.WindowSignal = _elm.Page.WindowSignal || {};
   if (_elm.Page.WindowSignal.values) return _elm.Page.WindowSignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   $Config$Color = Elm.Config.Color.make(_elm),
   ...
   var _op = {};
   var windowDimensionsElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                  ,_0: $Window.dimensions
                                                                                  ,_1: "Window.dimensions : dimensions : Signal (Int, Int)"
                                                                                  ,_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.down),_U.list([windowDimensionsElement]));
   return _elm.Page.WindowSignal.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.TimeEverySignal = Elm.Page.TimeEverySignal || {};
Elm.Page.TimeEverySignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.TimeEverySignal = _elm.Page.TimeEverySignal || {};
   if (_elm.Page.TimeEverySignal.values) return _elm.Page.TimeEverySignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   $Config$Color = Elm.Config.Color.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var timeEvery5SecondSignal = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                 ,_0: $Time.every(5 * $Time.second)
                                                                                 ,_1: "every (5 * second) : Time -> Signal Time"
                                                                                 ,_2: $Config$Color.elmBlue}]));
   var timeEverySecondSignal = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                ,_0: $Time.every($Time.second)
                                                                                ,_1: "every second : Time -> Signal Time"
                                                                                ,_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.down),_U.list([timeEverySecondSignal,timeEvery5SecondSignal]));
   return _elm.Page.TimeEverySignal.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.TimeFpsSignal = Elm.Page.TimeFpsSignal || {};
Elm.Page.TimeFpsSignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.TimeFpsSignal = _elm.Page.TimeFpsSignal || {};
   if (_elm.Page.TimeFpsSignal.values) return _elm.Page.TimeFpsSignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   $Config$Color = Elm.Config.Color.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var fiveFpsSignal = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                        ,_0: $Time.fps(5)
                                                                        ,_1: "fps 5 number -> Signal Time"
                                                                        ,_2: $Config$Color.elmBlue}]));
   var oneFpsSignal = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                       ,_0: $Time.fps(1)
                                                                       ,_1: "fps 1 number -> Signal Time"
                                                                       ,_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.down),_U.list([oneFpsSignal,fiveFpsSignal]));
   return _elm.Page.TimeFpsSignal.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.TimeFpsWhenSignal = Elm.Page.TimeFpsWhenSignal || {};
Elm.Page.TimeFpsWhenSignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.TimeFpsWhenSignal = _elm.Page.TimeFpsWhenSignal || {};
   if (_elm.Page.TimeFpsWhenSignal.values) return _elm.Page.TimeFpsWhenSignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   $Config$Color = Elm.Config.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Mouse = Elm.Mouse.make(_elm),
   $Page$MouseSignal = Elm.Page.MouseSignal.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Signal$Extra = Elm.Signal.Extra.make(_elm),
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var fpsWhenMouseDownElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                  ,_0: A2($Time.fpsWhen,1,$Mouse.isDown)
                                                                                  ,_1: "fpsWhenMouseDown : number -> Signal Bool -> Signal Time"
                                                                                  ,_2: $Config$Color.elmBlue}]));
   var fpsWhenMouseDownNote = $Component$Note.signalNote("fpsWhenMouseDown = Time.fpsWhen 1 Mouse.isDown");
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$MouseSignal.mouseIsDownElement,fpsWhenMouseDownNote,fpsWhenMouseDownElement]));
   return _elm.Page.TimeFpsWhenSignal.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.TimeDelaySignal = Elm.Page.TimeDelaySignal || {};
Elm.Page.TimeDelaySignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.TimeDelaySignal = _elm.Page.TimeDelaySignal || {};
   if (_elm.Page.TimeDelaySignal.values) return _elm.Page.TimeDelaySignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var timeDelaySignal = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                          ,_0: A2($Time.delay,$Time.second,$Mouse.clicks)
                                                                          ,_1: "delayedClick : Time -> Signal a -> Signal a"
                                                                          ,_2: $Config$Color.elmBlue}]));
   var timeDelayNote = $Component$Note.signalNote("delayedClick = Time.delay (second) Mouse.clicks");
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$MouseSignal.mouseClicksElement,timeDelayNote,timeDelaySignal]));
   return _elm.Page.TimeDelaySignal.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.TimeSinceSignal = Elm.Page.TimeSinceSignal || {};
Elm.Page.TimeSinceSignal.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.TimeSinceSignal = _elm.Page.TimeSinceSignal || {};
   if (_elm.Page.TimeSinceSignal.values) return _elm.Page.TimeSinceSignal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var timeSinceSignal = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                          ,_0: A2($Time.since,2 * $Time.second,$Mouse.clicks)
                                                                          ,_1: "twoSecondClick : Time -> Signal a -> Signal Bool"
                                                                          ,_2: $Config$Color.orange}]));
   var timeSinceNote = $Component$Note.signalNote("twoSecondClick = Time.since (2 * second) Mouse.clicks");
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$MouseSignal.mouseClicksElement,timeSinceNote,timeSinceSignal]));
   return _elm.Page.TimeSinceSignal.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalMap = Elm.Page.SignalMap || {};
Elm.Page.SignalMap.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalMap = _elm.Page.SignalMap || {};
   if (_elm.Page.SignalMap.values) return _elm.Page.SignalMap.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Char = Elm.Char.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Page$KeyboardSignal = Elm.Page.KeyboardSignal.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var keyboardChar = A2($Signal.map,$Char.fromCode,$Keyboard.presses);
   var keyboardCharElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                              ,_0: keyboardChar
                                                                              ,_1: "keyboardChar: Signal Char"
                                                                              ,_2: $Config$Color.elmBlue}]));
   var keyboardCharNote = $Component$Note.signalNote("keyboardChar = Signal.map Char.fromCode Keyboard.presses");
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$KeyboardSignal.keyboardPressesElement,keyboardCharNote,keyboardCharElement]));
   return _elm.Page.SignalMap.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalMap2 = Elm.Page.SignalMap2 || {};
Elm.Page.SignalMap2.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalMap2 = _elm.Page.SignalMap2 || {};
   if (_elm.Page.SignalMap2.values) return _elm.Page.SignalMap2.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var isBothTrue = F2(function (s,e) {    return s && e;});
   var isEnterAndSpacePressed = A3($Signal.map2,isBothTrue,$Keyboard.space,$Keyboard.enter);
   var isEnterAndSpacePressedElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                        ,_0: isEnterAndSpacePressed
                                                                                        ,_1: "isEnterAndSpacePressed : Signal Bool"
                                                                                        ,_2: $Config$Color.elmBlue}]));
   var keyboardCharNote = $Component$Note.signalNote("isEnterAndSpacePressed = map2 (\\(s, e) -> s && e) space enter");
   var keyboardEnterElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                               ,_0: $Keyboard.enter
                                                                               ,_1: "Keyboard.enter : Signal Bool"
                                                                               ,_2: $Config$Color.orange}
                                                                              ,{ctor: "_Tuple3"
                                                                               ,_0: $Keyboard.space
                                                                               ,_1: "Keyboard.space : Signal Bool"
                                                                               ,_2: $Config$Color.orange}]));
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([keyboardEnterElement,keyboardCharNote,isEnterAndSpacePressedElement]));
   return _elm.Page.SignalMap2.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalFilter = Elm.Page.SignalFilter || {};
Elm.Page.SignalFilter.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalFilter = _elm.Page.SignalFilter || {};
   if (_elm.Page.SignalFilter.values) return _elm.Page.SignalFilter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Char = Elm.Char.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var keyboardDigitNote = $Component$Note.signalNote("keyboardDigit = Signal.filter Char.isDigit 0 keyboardChar");
   var keyboardChar = A2($Signal.map,$Char.fromCode,$Keyboard.presses);
   var keyboardCharElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                              ,_0: keyboardChar
                                                                              ,_1: "keyboardChar: Signal Char"
                                                                              ,_2: $Config$Color.orange}]));
   var keyboardDigit = A3($Signal.filter,$Char.isDigit,_U.chr("0"),keyboardChar);
   var keyboardDigitElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                               ,_0: keyboardDigit
                                                                               ,_1: "keyboardDigit : Signal Bool"
                                                                               ,_2: $Config$Color.elmBlue}]));
   var keyboardCharNote = $Component$Note.signalNote("keyboardChar = Signal.map Char.fromCode Keyboard.presses");
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$KeyboardSignal.keyboardPressesElement,keyboardCharNote,keyboardCharElement,keyboardDigitNote,keyboardDigitElement]));
   return _elm.Page.SignalFilter.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalFoldp = Elm.Page.SignalFoldp || {};
Elm.Page.SignalFoldp.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalFoldp = _elm.Page.SignalFoldp || {};
   if (_elm.Page.SignalFoldp.values) return _elm.Page.SignalFoldp.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var clicksCounterNote = $Component$Note.signalNote("counter = Signal.foldp (\\_ n -> n + 1) 0 Mouse.clicks");
   var clicksCounter = A3($Signal.foldp,F2(function (_p0,count) {    return count + 1;}),0,$Mouse.clicks);
   var counter = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3",_0: clicksCounter,_1: "counter : Signal Int",_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$MouseSignal.mouseClicksElement,clicksCounterNote,counter]));
   return _elm.Page.SignalFoldp.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalMerge = Elm.Page.SignalMerge || {};
Elm.Page.SignalMerge.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalMerge = _elm.Page.SignalMerge || {};
   if (_elm.Page.SignalMerge.values) return _elm.Page.SignalMerge.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var clickPressTickNote = $Component$Note.signalNote("clickPressTick = mergeMany [ clicksAction, keyPresses, tickAction ]");
   var clicksAndPressNote = $Component$Note.signalNote("clicksAndPress = Signal.merge clicksAction keyPresses");
   var Tick = {ctor: "Tick"};
   var tickAction = A2($Signal.map,$Basics.always(Tick),$Time.every($Time.second));
   var tickActionElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                            ,_0: tickAction
                                                                            ,_1: "tickAction : Signal Action"
                                                                            ,_2: $Config$Color.orange}]));
   var Press = {ctor: "Press"};
   var keyPresses = A2($Signal.map,$Basics.always(Press),$Keyboard.presses);
   var keyPressesElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                            ,_0: keyPresses
                                                                            ,_1: "keyPresses : Signal Action"
                                                                            ,_2: $Config$Color.yellow}]));
   var Click = {ctor: "Click"};
   var clicksAction = A2($Signal.map,$Basics.always(Click),$Mouse.clicks);
   var clicksActionElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                              ,_0: clicksAction
                                                                              ,_1: "clicksAction : Signal Action"
                                                                              ,_2: $Config$Color.green}]));
   var clicksAndPress = A2($Signal.merge,clicksAction,keyPresses);
   var clicksAndPressElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                ,_0: clicksAndPress
                                                                                ,_1: "clicksAndPress : Signal Action"
                                                                                ,_2: $Config$Color.elmBlue}]));
   var clickPressTick = $Signal.mergeMany(_U.list([clicksAction,keyPresses,tickAction]));
   var clickPressTickElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                ,_0: clickPressTick
                                                                                ,_1: "clickPressTick : Signal Action"
                                                                                ,_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([clicksActionElement,keyPressesElement,tickActionElement,clicksAndPressNote,clicksAndPressElement,clickPressTickNote,clickPressTickElement]));
   return _elm.Page.SignalMerge.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalDropRepeats = Elm.Page.SignalDropRepeats || {};
Elm.Page.SignalDropRepeats.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalDropRepeats = _elm.Page.SignalDropRepeats || {};
   if (_elm.Page.SignalDropRepeats.values) return _elm.Page.SignalDropRepeats.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var dropRepeatsPressesNote = $Component$Note.signalNote("dropRepeatsPresses = Signal.dropRepeats Keyboard.presses");
   var dropRepeatsPresses = $Signal.dropRepeats($Keyboard.presses);
   var dropRepeatsPressesElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                                    ,_0: dropRepeatsPresses
                                                                                    ,_1: "dropRepeatsPresses : Signal Int"
                                                                                    ,_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$KeyboardSignal.keyboardPressesElement,dropRepeatsPressesNote,dropRepeatsPressesElement]));
   return _elm.Page.SignalDropRepeats.values = {_op: _op,view: view};
};
Elm.Page = Elm.Page || {};
Elm.Page.SignalSampleOn = Elm.Page.SignalSampleOn || {};
Elm.Page.SignalSampleOn.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.SignalSampleOn = _elm.Page.SignalSampleOn || {};
   if (_elm.Page.SignalSampleOn.values) return _elm.Page.SignalSampleOn.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Note = Elm.Component.Note.make(_elm),
   $Component$Sandbox = Elm.Component.Sandbox.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var clickTimeNote = $Component$Note.signalNote("clickTime = Signal.sampleOn mouseClicks everySecond");
   var everySecond = $Time.every($Time.second);
   var everySecondElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                             ,_0: everySecond
                                                                             ,_1: "everySecond : Signal Time.Time"
                                                                             ,_2: $Config$Color.elmBlue}]));
   var clickTime = A2($Signal.sampleOn,$Mouse.clicks,everySecond);
   var clickTimeElement = $Component$Sandbox.displaySimpleSandbox(_U.list([{ctor: "_Tuple3"
                                                                           ,_0: clickTime
                                                                           ,_1: "clickTime : Signal Time.Time"
                                                                           ,_2: $Config$Color.elmBlue}]));
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
   _U.list([$Page$MouseSignal.mouseClicksElement,everySecondElement,clickTimeNote,clickTimeElement]));
   return _elm.Page.SignalSampleOn.values = {_op: _op,view: view};
};
Elm.Route = Elm.Route || {};
Elm.Route.make = function (_elm) {
   ...
   $Page$KeyboardSignal = Elm.Page.KeyboardSignal.make(_elm),
   $Page$MouseSignal = Elm.Page.MouseSignal.make(_elm),
   $Page$SignalDropRepeats = Elm.Page.SignalDropRepeats.make(_elm),
   $Page$SignalFilter = Elm.Page.SignalFilter.make(_elm),
   $Page$SignalFoldp = Elm.Page.SignalFoldp.make(_elm),
   $Page$SignalMap = Elm.Page.SignalMap.make(_elm),
   $Page$SignalMap2 = Elm.Page.SignalMap2.make(_elm),
   $Page$SignalMerge = Elm.Page.SignalMerge.make(_elm),
   $Page$SignalSampleOn = Elm.Page.SignalSampleOn.make(_elm),
   $Page$TimeDelaySignal = Elm.Page.TimeDelaySignal.make(_elm),
   $Page$TimeEverySignal = Elm.Page.TimeEverySignal.make(_elm),
   $Page$TimeFpsSignal = Elm.Page.TimeFpsSignal.make(_elm),
   $Page$TimeFpsWhenSignal = Elm.Page.TimeFpsWhenSignal.make(_elm),
   $Page$TimeSinceSignal = Elm.Page.TimeSinceSignal.make(_elm),
   $Page$WindowSignal = Elm.Page.WindowSignal.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Router = Elm.Router.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var routing = F4(function (hash,basic,time,core) {
      var _p0 = core;
      var map = _p0._0;
      var map2 = _p0._1;
      var filter = _p0._2;
      var foldp = _p0._3;
      var merge = _p0._4;
      var dropRepeats = _p0._5;
      var sampleOn = _p0._6;
      var _p1 = time;
      var timeEvery = _p1._0;
      var timeFps = _p1._1;
      var timeFpsWhen = _p1._2;
      var timeDelay = _p1._3;
      var timeSince = _p1._4;
      var _p2 = basic;
      var mouse = _p2._0;
      var keyboard = _p2._1;
      var window = _p2._2;
      var allPage = A2($Router.match,
      _U.list([A2($Router._op[":->"],"",$Basics.always(mouse))
              ,A2($Router._op[":->"],"#/mouseSignal",$Basics.always(mouse))
              ,A2($Router._op[":->"],"#/keyboardSignal",$Basics.always(keyboard))
              ,A2($Router._op[":->"],"#/windowSignal",$Basics.always(window))
              ,A2($Router._op[":->"],"#/timeEvery",$Basics.always(timeEvery))
              ,A2($Router._op[":->"],"#/timeFpsWhen",$Basics.always(timeFpsWhen))
              ,A2($Router._op[":->"],"#/timeFps",$Basics.always(timeFps))
              ,A2($Router._op[":->"],"#/timeDelay",$Basics.always(timeDelay))
              ,A2($Router._op[":->"],"#/timeSince",$Basics.always(timeSince))
              ,A2($Router._op[":->"],"#/signalMap2",$Basics.always(map2))
              ,A2($Router._op[":->"],"#/signalMap",$Basics.always(map))
              ,A2($Router._op[":->"],"#/signalFilter",$Basics.always(filter))
              ,A2($Router._op[":->"],"#/signalFoldp",$Basics.always(foldp))
              ,A2($Router._op[":->"],"#/signalMerge",$Basics.always(merge))
              ,A2($Router._op[":->"],"#/signalDropRepeats",$Basics.always(dropRepeats))
              ,A2($Router._op[":->"],"#/signalSampleOn",$Basics.always(sampleOn))]),
      $Basics.always(mouse));
      return allPage(hash);
   });
   var hashSignal = A2($Signal.map,$Debug.log("hash"),$History.hash);
   var coreSignals = A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   ...
   $Page$SignalMap.view),
   $Page$SignalMap2.view),
   $Page$SignalFilter.view),
   $Page$SignalFoldp.view),
   $Page$SignalMerge.view),
   $Page$SignalDropRepeats.view),
   $Page$SignalSampleOn.view);
   var timeSignals = A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["~"],
   A2($Signal$Extra._op["<~"],F5(function (v0,v1,v2,v3,v4) {    return {ctor: "_Tuple5",_0: v0,_1: v1,_2: v2,_3: v3,_4: v4};}),$Page$TimeEverySignal.view),
   $Page$TimeFpsSignal.view),
   $Page$TimeFpsWhenSignal.view),
   $Page$TimeDelaySignal.view),
   $Page$TimeSinceSignal.view);
   var basicSignals = A3($Signal$Extra.zip3,$Page$MouseSignal.view,$Page$KeyboardSignal.view,$Page$WindowSignal.view);
   var routes = A5($Signal.map4,routing,hashSignal,basicSignals,timeSignals,coreSignals);
   return _elm.Route.values = {_op: _op,routes: routes};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Container = Elm.Component.Container.make(_elm),
   $Component$NavBar = Elm.Component.NavBar.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var appView = A2($Signal.map,
   $Html.fromElement,
   A2($Signal$Extra.mapMany,$Graphics$Element.flow($Graphics$Element.right),_U.list([$Component$NavBar.navBarSignal,$Route.routes])));
   var main = $Component$Container.container(appView);
   return _elm.Main.values = {_op: _op,appView: appView,main: main};
};
